...
public class FrameThongKeNhanVien extends javax.swing.JFrame {
    ...
    public FrameThongKeNhanVien() {
        ...
        controller.getTblTongSoPhieuDaTao();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Số phiếu mượn nhân viên đã tạo:");
        ...
        tblNV.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã nhân viên", "Tên nhân viên", "Số phiếu mượn đã tạo"
            }
        ) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameThongKeNhanVien().setVisible(true);
            }
        });
    }
    ...
    public JTable getTblTongSoPhieuDaTao(){
        return tblNV;
    }
